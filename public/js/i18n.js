...
(function (global) {
  ...
  const STR = {
    en: {
      ...
      kioskMainItem: 'Main item (computer or other)',
      ...
      devThName: 'Name',
      devNoBrands: 'No brands yet. Add one above.',
      devEdit: 'Edit',
      devDelete: 'Delete',
      devSave: 'Save',
      devCancel: 'Cancel',
      ...
      loanReturnHint: 'Returning frees the main item and any charger borrowed together.',
      loanThSince: 'Since',
      ...
      loanListEmpty: 'No items yet. Add one above.',
      loanRemove: 'Remove',
    ...
    sv: {
      ...
      brandSubtitle: 'Logga och följ ärenden — Abitti, hårdvara och konton',
      ...
      kioskMainItem: 'Lånedator (eller annat)',
      ...
      devThName: 'Namn',
      devNoBrands: 'Inga varumärken ännu. Lägg till ovan.',
      devEdit: 'Redigera',
      devDelete: 'Ta bort',
      devSave: 'Spara',
      devCancel: 'Avbryt',
      ...
      devThLabel: 'Etikett',
      devNoDevices: 'Inga enheter ännu.',
      devConfirmDevice:
      ...
      loanReturnHint: 'Vid återlämning frigörs huvudartikeln och eventuell laddare som lånats tillsammans.',
      loanThSince: 'Sedan',
      ...
      loanPhComputer: 't.ex. laptopvagn A-12',
      ...
      loanListEmpty: 'Inga poster ännu. Lägg till ovan.',
      loanRemove: 'Ta bort',
